...
import revenueExpenditure from './revenueExpenditure.json'
...
class BarGraphs extends React.Component {
    render() {
        return (
            <React.Fragment>
                {
                    revenueExpenditure.map((object, key) => {
                        const yAxisTitle = `${object['Function']} ${object['Major Account Head Description']} ${object['Detailed Account Code Description']}`;
                        ...
                        const config = {
                            ...
                            title: {
                                text: `Revenue Expenditure - ${yAxisTitle}`
                            },
                            subtitle: {
